...
function get_breadcrumbs() {
	...
	$show_title     = 1;
	$delimiter      = ' ';
	$before         = '<li class="home_breadcrumb">';
	$after          = '</li>';

	global $post;
	$home_link    = home_url('/');
	$link_before  = '<li class="home_breadcrumb">';
	$link_after   = '</li>';
	$link_attr    = ' ';
	...
	if (is_home() || is_front_page()) {
		...
		echo '<div class="home_breadcrumbs" >';
		echo '<ul class="home_breadcrumbs_list">';
